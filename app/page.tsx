...
function videoDescription(fileName: string) {
  if (fileName === "gowri-ganesh-festival-celebration.mp4") {
    return "Devotees gather in the temple for the 2026 Gowri Ganesh festival celebrations.";
  }
  if (fileName === "gowri-ganesh-festival-temple.mp4") {
    return "A festival-day view of the historic temple decorated for Gowri Ganesh celebrations.";
  }
